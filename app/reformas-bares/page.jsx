// app/reformas-bares/page.jsx — Server Component (sin "use client")
export const dynamic = "force-static";

export const metadata = {
    title: "robotARQ — Reformas de Bares | Genera tu Presupuesto Técnico",
    description:
        "Describe tu reforma y generamos un presupuesto técnico con partidas, cantidades y precios. Descarga en PDF o Excel.",
    robots: "index, follow",
...
export default function ReformasBaresLandingV1() {
    return (
        <main className="bg-white text-[#0a0a0a]">
            ...
            <Section className="pt-14 pb-6">
                ...
                <p className="mt-4 text-lg sm:text-xl text-neutral-700 max-w-3xl">
                    ...
                    <strong>presupuesto técnico</strong> con partidas, cantidades y precios. Descárgalo en{" "}
                    <strong>PDF</strong> o <strong>Excel</strong>.
                </p>

                {/* Formulario -> /estimador (más protagonista) */}
                <div className="mt-8">
                    <form
                        action="/estimador"
                        method="GET"
                    ...
                    >
                        ...
                        <p className="mt-3 text-sm text-neutral-500">
                            Describe tu reforma · partidas · cantidades · precios · descarga y comparte.
                        </p>
                    </form>
                </div>
            </Section>
            ...
            {/* ===== Ejemplos de precios (estética más “Apple-like”) ===== */}
